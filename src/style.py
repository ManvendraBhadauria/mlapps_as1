...
[class="st-emotion-cache-ztfqz8 ef3psqc5"]{
    color:black;
}
[class="st-emotion-cache-iiif1v ef3psqc4"]{
    color:white;
}
[class="st-emotion-cache-1wbqy5l e17vllj40"]{
    color:white;
}
...
[class="st-ag st-ah st-ai st-aj st-ak st-al st-am"]{
padding-top:7px;
}
